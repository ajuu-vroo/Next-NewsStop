        ...
        <header className="text-gray-600 body-font -mt-4 fixed z-50 top-0 right-0 left-0 pt-1 backdrop-blur-lg">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0 lg:pr-44 cursor-pointer" href='/'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="w-10 h-10 text-red-800 p-2 bg-gray-50 rotate-90 rounded-full" viewBox="0 0 24 24">
                        <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" />
                    </svg>
                    <span className="ml-3 text-2xl text-red-800">𝕹𝖊𝖜𝖘𝕾𝖙𝖔𝖕.𝖈𝖔𝖒</span>
                </a>
          ...
          <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="w-4 h-4 ml-1" viewBox="0 0 24 24">
            <path d="M5 12h14M12 5l7 7-7 7" />
                ...
                <div className="relative inline-block text-left z-40 group rounded-md mt-2 lg:ml-4 lg:mt-0">
                    <div>
                        <button type="button" className=" border border-gray-300 bg-red-700 dark:bg-gray-800 shadow-sm flex items-center justify-center w-full rounded-md  px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-50 hover:bg-red-600 dark:hover:bg-gray-500 " id="options-menu">
                            <h1 className='pr-1 text-white'>Explore</h1>
                            <svg width="20" height="20" fill="currentColor" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg" className='text-white'>
                                <path d="M1408 704q0 26-19 45l-448 448q-19 19-45 19t-45-19l-448-448q-19-19-19-45t19-45 45-19h896q26 0 45 19t19 45z">
                                </path>
                            </svg>
                        </button>
                    </div>
                    <div className="origin-top-right absolute mt-0 w-56 rounded-md shadow-lg bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 hidden group-hover:flex">
                        ...
                        <Link href='/business'>
                            ...
                            <Link href='/sports'>
                            <a href="#" className="px-4 py-2 text-md text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-100 dark:hover:text-white dark:hover:bg-gray-600 block" role="menuitem">
                                <span className="flex flex-col">
                                    <span>
                                        Sports
                                    </span>
