    ...
    return (
        <section className="flex flex-col sm:flex-row bg-gray-100 py-5 h-full md:mx-10 items-center justify-center ">
            <div className=''>
                ...
                ' src={data?.urlToImage || "https://previews.123rf.com/images/bluebay/bluebay1409/bluebay140900035/31543593-words-news-on-digital-red-background.jpg"} alt="Image Unavailable" />
            </div>
